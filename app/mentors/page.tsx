...
import { ArrowRight, Clock, ChartLine, Cpu, Radio, Star } from 'lucide-react';
...
const sessionTypes = [
  {
    ...
    description:
      'A 45-minute walkthrough of what the field actually looks like from the inside \u2014 daily work, tools, team structures, and what juniors are expected to know.',
    duration: '45 min',
    bestFor:
      'You completed the assessment and want to hear from someone in the field',
  },
  {
    id: 'decision',
    title: 'Decision Help',
    description:
      'You are stuck between two tracks. The mentor reviews your assessment results and helps you reason through the decision with real-world context.',
    duration: '45 min',
  ...
  },
  {
    ...
    description:
      'You have started learning but feel lost or uncertain about your path. The mentor reviews where you are and helps you refocus your next 30 days.',
    duration: '45 min',
        ...
        <div className='mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <div className='mx-auto max-w-2xl text-center mb-16'>
            ...
            <p className='text-muted-foreground text-lg'>
              45 minutes with a working engineer in your matched track. Real
              answers, no fluff.
            </p>
          ...
          <section className='mb-16'>
            <h2 className='text-base font-semibold font-mono mb-6'>
              Session types
            </h2>
              ...
              {sessionTypes.map((type) => (
                <div
                  ...
                  <div className='flex items-start gap-2'>
                    <span className='text-[10px] text-muted-foreground uppercase tracking-wider flex-shrink-0 mt-0.5'>
                      Best for
                    </span>
                ...
                <div
                  ...
                  <div className='flex items-start justify-between gap-4'>
                    <div className='flex items-start gap-4'>
                      {/* Avatar placeholder */}
                      <div
                        className={`w-12 h-12 rounded-xl border ${mentor.borderColor} bg-secondary flex items-center justify-center flex-shrink-0`}>
                        <mentor.TrackIcon
                          className={`h-5 w-5 ${mentor.color}`}
                        />
                      </div>
                      <div>
                  ...
                  <div className='flex items-center gap-2'>
                    <span
                      className={`text-[11px] font-mono px-2 py-0.5 rounded-full border ${mentor.badgeColor}`}>
                      {mentor.trackName}
                    </span>
                    <span className='text-xs text-muted-foreground'>
          ...
          <div className='mt-12 rounded-xl border border-border/40 bg-secondary/20 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
            <div>
              <h3 className='text-sm font-semibold mb-1'>
                Not sure which session type to book?
              </h3>
              <p className='text-sm text-muted-foreground'>
                Take the free assessment first. Your results will help the
                mentor prepare before your session.
              </p>
            </div>
            <Button
              variant='outline'
