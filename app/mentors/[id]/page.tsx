...
const iconMap = { ChartLine, Cpu, Radio };
...
const sessionTypes = [
  {
    ...
    description:
      'A 45-minute walkthrough of what the field actually looks like from the inside.',
    duration: '45 min',
  },
  {
    id: 'decision',
    title: 'Decision Help',
    description:
      'Mentor reviews your assessment results and helps you reason through the decision.',
    duration: '45 min',
  },
  {
    id: 'roadmap',
    ...
    description:
      'Mentor reviews where you are and helps you refocus your next 30 days.',
    duration: '45 min',
  },
];
...
export default async function MentorBookingPage({
  ...
  const availableSessions = sessionTypes.filter((s) =>
    mentor.sessions.includes(s.id),
  );
    ...
    <>
      ...
      <main className='min-h-screen bg-background pt-20'>
        <div className='mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16'>
          {/* Mentor header */}
          <div
            className={`rounded-xl border ${mentor.borderColor} ${mentor.bgColor} p-8 mb-8`}>
            <div className='flex items-start gap-5'>
              <div
                className={`w-16 h-16 rounded-xl border ${mentor.borderColor} bg-secondary flex items-center justify-center flex-shrink-0`}>
              ...
              <div className='flex-1 min-w-0'>
                ...
                <div className='flex flex-wrap items-center gap-2 mt-3'>
                  ...
                  {mentor.languages.map((l, i) => (
                    <span
                      key={i}
                      className='text-xs text-muted-foreground border border-border/40 rounded px-1.5 py-0.5'>
                      {l}
                    </span>
                  ))}
                </div>
          ...
          {/* Session selection */}
          <div className='mb-8'>
            <h2 className='text-base font-semibold font-mono mb-5'>
                ...
                <div
                  ...
                  <div className='flex items-start justify-between gap-4'>
                    ...
                    <Button size='sm' className='flex-shrink-0' asChild>
                      <Link
                        href={`/checkout?mentor=${id}&session=${session.id}`}>
                        Book \u2014 $29
