...
export const metadata = {
  ...
  description:
    'Explore the 3 electrical engineering specializations: Power Systems, Embedded Systems, and Communications Systems.',
};
        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16'>
          ...
          <div className='mx-auto max-w-2xl text-center mb-16'>
            ...
            <p className='text-muted-foreground text-lg'>
              TrackUp covers three core specializations. Take the free
              assessment to find which one fits your profile.
            </p>
              ...
              return (
                <div
                  ...
                  <div className='flex items-center gap-3'>
                    <div
                      className={`p-2.5 rounded-lg bg-secondary border ${track.borderColor}`}>
                      <Icon className={`h-5 w-5 ${track.color}`} />
                    </div>
                    <h2
                      className={`font-mono font-bold text-xl ${track.color}`}>
                      {track.name}
                    </h2>
                  </div>
                    ...
                    <ul className='space-y-2'>
                      {track.fitsYouIf.slice(0, 3).map((fit, i) => (
                        <li
                          ...
                          <span
                            className={`h-1.5 w-1.5 rounded-full flex-shrink-0 mt-1.5 ${track.accentColor}`}
                          />
                          {fit}
                        </li>
                      ))}
