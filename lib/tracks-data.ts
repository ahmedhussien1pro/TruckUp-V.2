...
export const tracks: TrackData[] = [
  {
    ...
    name: 'Power Systems',
    shortDescription:
      'Energy generation, transmission, and distribution at scale.',
    fullDescription:
    ...
    tools: [
      ...
      { name: 'MATLAB / Simulink', purpose: 'Modeling and control design' },
      {
        ...
        purpose: 'Electrical drawing and schematics',
      },
      { name: 'PSCAD', purpose: 'Transient simulation' },
      {
        name: 'PLC (Siemens / ABB)',
    ...
    misconceptions: [
      {
        ...
        reality:
          'Modern power engineering involves complex control systems, power electronics, digital protection, and grid-scale optimization.',
      },
      {
        myth: 'The field is declining because of renewables',
        reality:
          'The energy transition is creating massive demand for power engineers who understand both legacy grid systems and new renewable integration.',
      },
      {
        myth: 'You need to be on-site in dangerous conditions constantly',
        reality:
          'Most roles split time between office analysis and occasional site work. Safety protocols are strict and well-defined.',
      },
    ],
    entryPath: [
  ...
  },
  {
    ...
    shortDescription:
      'Programming microcontrollers and building hardware-software interfaces.',
    fullDescription:
    ...
    tools: [
      {
        name: 'STM32 / ESP32',
        purpose: 'Professional microcontroller platforms',
      },
      ...
      { name: 'GDB / OpenOCD', purpose: 'Debugging and flashing' },
      {
        ...
        purpose: 'Hardware signal debugging',
      },
    ...
    misconceptions: [
      {
        ...
        reality:
          'Professional embedded work involves STM32, RTOS, communication protocols, safety-critical systems, and strict coding standards like MISRA C.',
      },
      {
        myth: 'You need a software engineering background',
        reality:
          'Embedded is a distinct discipline. EE students with strong C skills and hardware understanding are highly valued, often more than software-only developers.',
      },
      {
        myth: 'The job is mostly soldering and hardware assembly',
        reality:
          'Most embedded roles are primarily firmware development, debugging, and integration. Hardware design is a separate (though related) specialization.',
      },
    ],
    entryPath: [
  ...
  },
  {
    ...
    shortDescription:
      'Signal processing, wireless transmission, and data communication design.',
    fullDescription:
    ...
    tools: [
      {
        ...
        purpose: 'Signal processing and system simulation',
      },
      {
        name: 'GNU Radio',
        purpose: 'Software-defined radio and SDR experiments',
      },
      {
        name: 'Python (NumPy/SciPy)',
        purpose: 'DSP scripting and data analysis',
      },
      { name: 'Wireshark', purpose: 'Protocol analysis and packet inspection' },
      { name: 'Spectrum Analyzer / VNA', purpose: 'RF measurements' },
      {
        name: 'OFDM / 5G NR toolboxes',
        purpose: 'Modern wireless systems simulation',
      },
    ],
    fitsYouIf: [
    ...
    misconceptions: [
      {
        ...
        reality:
          'Communications engineering is a deep technical field involving signal theory, antenna design, modulation, channel coding, and RF systems — far beyond IT networking.',
      },
      {
        myth: 'You need to be a math genius',
        reality:
          'Strong math helps, but practical communications work involves simulation tools, standards documents, and systematic design — not solving equations from scratch daily.',
      },
      {
        myth: 'The field is saturated because of software-defined everything',
        reality:
          'SDR and 5G/6G development have increased demand for engineers who understand the physical layer — a skill that pure software developers lack.',
      },
    ],
    entryPath: [
