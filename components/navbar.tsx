...
import { Menu, X, User, LogOut, ChevronDown, ChartLine } from 'lucide-react';
          ...
          {user ? (
            <div className='relative'>
              <button
                ...
                {user.isPremium && (
                  <span className='text-[9px] font-mono bg-accent/20 text-accent border border-accent/30 px-1 rounded'>
                    PRO
                  </span>
                )}
